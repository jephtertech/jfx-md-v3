        ...
        if (call.status === 'offer' && !call.isGroup) {
          ...
          if (!recentCallers.has(call.from)) {
            ...
            await client.sendMessage(call.from, {
              text: "```ʜɪɪ ᴛʜɪꜱ ɪꜱ ᴊꜰx ᴍᴅ-xᴠ3 ᴀ ᴘᴇʀꜱᴏɴᴀʟ ᴀꜱꜱɪꜱᴛᴀɴᴛ!! ꜱᴏʀʀʏ ꜰᴏʀ ɴᴏᴡ, ᴡᴇ ᴄᴀɴɴᴏᴛ ʀᴇᴄᴇɪᴠᴇ ᴄᴀʟʟꜱ, ᴡʜᴇᴛʜᴇʀ ɪɴ ᴀ ɢʀᴏᴜᴘ ᴏʀ ᴘᴇʀꜱᴏɴᴀʟ ɪꜰ ʏᴏᴜ ɴᴇᴇᴅ ʜᴇʟᴘ ᴏʀ ʀᴇQᴜᴇꜱᴛ ꜰᴇᴀᴛᴜʀᴇꜱ ᴘʟᴇᴀꜱᴇ ᴄʜᴀᴛ ᴏᴡɴᴇʀ```",
              mentions: [call.from]
            });
